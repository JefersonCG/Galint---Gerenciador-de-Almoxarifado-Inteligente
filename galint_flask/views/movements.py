...
def item_info(codigo: str):
    ...
    response = {
        ...
        "valor_referencia": financial_reference,
        "preco_reposicao_unitario": item.get("preco_reposicao_unitario"),
        "preco_reposicao_unitario_base": item.get("preco_reposicao_unitario_base"),
        "preco_reposicao_unidade_preco": item.get("preco_reposicao_unidade_preco"),
        "preco_reposicao_fator_base": item.get("preco_reposicao_fator_base"),
