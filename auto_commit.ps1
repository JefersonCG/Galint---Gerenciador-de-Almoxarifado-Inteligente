# Script de Auto-Commit - GALINT Mobile
...
Write-Host "`n🔍 GALINT Mobile - Auto Commit" -ForegroundColor Cyan
...
if ($LASTEXITCODE -eq 0) {
    ...
    git log -1 --pretty=format:"%h - %s (%ci)" --stat
} else {
...
Write-Host "💡 Dica: Use 'git log' para ver histórico completo" -ForegroundColor Gray
